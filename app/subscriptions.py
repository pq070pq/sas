...
TERMS_VERSION = "2.0"
TERMS_TEXT = """SAS PRO قناة إخبارية وتعليمية متخصصة في سوق الأسهم الأمريكية، تقدم أخباراً وتحليلات ومعلومات عامة عن السوق، وليست قناة لتقديم توصيات شراء أو بيع أو استشارات استثمارية شخصية.

تتضمن الخدمة التحليل الفني للأسهم وحركة الأسعار والمؤشرات الفنية لأغراض تعليمية وإخبارية، ولا تمثل النتائج أو التحليلات ضماناً للربح أو تجنب الخسارة.

يقر المشترك بأن التداول والاستثمار ينطويان على مخاطر، وأن قرار التداول والاستثمار وإدارة رأس المال والمخاطر مسؤوليته الشخصية.

ولا تتحمل القناة أو مالكوها أو مسؤولوها أو مشرفوها مسؤولية أي خسائر أو أضرار ناتجة عن قرارات التداول أو الاستثمار التي يتخذها المشترك، وذلك في حدود ما يسمح به النظام.

☑️ أقر بقراءة الشروط وفهم مخاطر التداول والموافقة عليها."""
