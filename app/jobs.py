...
async def weekly_radar_report():
    ...
    async with SessionLocal() as db:
        ...
        text += "\n\n━━━━━━━━━━━━━━\n⚠️ تنبيه: هذه الإحصائية تقيس وصول السعر إلى المستويات المحسوبة فقط، ولا تُعد نتيجة تداول فعلية ولا تضمن النتائج المستقبلية. قرار التداول وإدارة المخاطر مسؤولية المستخدم."
        try:
