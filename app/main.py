...
"""
DISCLAIMER = "⚠️ تنبيه: المعلومات والتحليلات هنا عامة ولأغراض معلوماتية وتعليمية، وليست توصية أو مشورة استثمارية شخصية. الأهداف والمستويات تحليلية وليست ضمانًا لأي نتيجة أو ربح. قرار التداول وإدارة المخاطر مسؤولية المستخدم."
PLANS = {
