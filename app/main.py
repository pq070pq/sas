...
أقر أنا المتداول بأن المعلومات والتحليلات والبيانات الواردة في SAS PRO والقناة لأغراض معلوماتية وتعليمية عامة فقط، ولا تُعد توصية أو مشورة استثمارية شخصية، ولا تراعي أهدافي الاستثمارية أو وضعي المالي أو احتياجاتي الاستثمارية.

🎯 الأهداف والمستويات والإشارات والقراءات المذكورة هي نتائج تحليلية مبنية على البيانات المتاحة وقت التحليل، وليست ضمانًا لتحقيق أي نتيجة أو ربح.

📊 الأسعار والبيانات والأخبار والمعلومات من المصادر الخارجية قد تكون متأخرة أو غير مكتملة أو تحتوي على أخطاء، وقد تتغير ظروف السوق بسرعة. أتحمل مسؤولية التحقق من المعلومات قبل اتخاذ أي قرار.

💰 SAS PRO لا تستلم أموالي ولا تدير أموالي أو محفظتي ولا تنفذ صفقات نيابة عني، ولا تضمن تحقيق أرباح أو تجنب الخسائر.

⚠️ أقر بأن الاستثمار والتداول ينطويان على مخاطر، وقد أخسر جزءًا من رأس المال أو كامل رأس المال المستخدم في التداول.

🧑‍💼 قرار الاستثمار والشراء والبيع وتحديد حجم الصفقة وإدارة رأس المال وإدارة المخاطر مسؤولية المتداول وحده، وأتحمل أنا كامل النتائج والخسائر المترتبة على قراراتي وتداولاتي. ولا تُعد SAS PRO أو القناة بديلًا عن المستشار المالي المرخص أو التقييم المستقل.

🚫 لا يجوز اعتبار أي محتوى في SAS PRO أو القناة تفويضًا بإدارة الأموال أو المحفظة أو تنفيذ الصفقات، ولا يجوز استخدامه على أنه ضمان للربح.

📌 استمرار استخدام SAS PRO بعد قراءة هذه الشروط والموافقة عليها يعني إقراري وفهمي وقبولي بهذه الشروط.

ملاحظة تنظيمية: هذه الشروط تهدف إلى توضيح طبيعة الخدمة ومسؤوليات المتداول، ولا تُعد بحد ذاتها ترخيصًا لممارسة أي نشاط منظم في السوق المالية أو تأكيدًا من هيئة السوق المالية على الخدمة.
"""
